...
contract ElyfiGovernor is Governor, GovernorTimelockControl {
    constructor(address policy, TimelockController _timelock)
        Governor("ElyfiGovernor")
    ...
    {
        DataStruct.ProposalVote storage proposalvote = _proposalVotes[
            proposalId
        ];
        return (
    ...
    function _countVote(
        ...
        require(
            ...
            "ElyfiGovernor: vote already casted"
        );
